...
} from "./file.core"; // Adjust the import path as necessary
import { errorLogger, infoLogger } from "../logger/logger.core"; // Adjust the import path as necessary

jest.mock("fs");
jest.mock("../logger/logger.core", () => ({
  errorLogger: {
    error: jest.fn(),
  },
  infoLogger: {
