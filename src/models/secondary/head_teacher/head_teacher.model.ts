...
// Define the HeadTeacher schema
export const HeadTeacherSchema = new Schema<IHeadTeacher>({
  //basic information
  image: {
    type: String,
  ...
  head_teacher_index: {
    type: Number,
    required: [true, "HeadTeacher Index is required"],
  },
  name: {
    type: String,
...
export const getHeadTeacherModel = async (school_uid: string) => {
  return await getSchoolModel<IHeadTeacher>(
    school_uid,
    ENUM_SHRADED_DATABASE_NAMES.HEAD_TEACHER_MODEL_NAME,
    HeadTeacherSchema
  );
};
